...
export default function LayananUnggulanPage() {
    ...
    const [selectedLayanan, setSelectedLayanan] = useState<LayananUnggulan | null>(null);
    ...
    const isAllSelected = currentLayanan.length > 0 &&
        currentLayanan.every(l => selectedIds.has(l.id));

    const isSomeSelected = currentLayanan.some(l => selectedIds.has(l.id)) && !isAllSelected;
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Gagal menyimpan data layanan';
    ...
    const handleBulkDelete = async () => {
        ...
        const loadingToast = toast.loading(`Menghapus ${selectedIds.size} layanan...`);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl lg:text-3xl font-bold tracking-tight">Layanan Unggulan</h1>
                    <p className="text-muted-foreground mt-1">
                        Kelola layanan unggulan untuk ditampilkan di website
                    </p>
                </div>
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>
                            {selectedLayanan ? 'Edit Layanan' : 'Tambah Layanan'}
                        </DialogTitle>
                        <DialogDescription>
                            {selectedLayanan
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <strong>{selectedLayanan?.title}</strong>? Tindakan ini tidak dapat dibatalkan.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            <AlertDialog open={bulkDeleteDialogOpen} onOpenChange={setBulkDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Hapus {selectedIds.size} Layanan?</AlertDialogTitle>
                        <AlertDialogDescription>
                            Apakah Anda yakin ingin menghapus {selectedIds.size} layanan yang dipilih?
