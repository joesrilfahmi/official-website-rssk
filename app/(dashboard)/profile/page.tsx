...
export default function ProfilePage() {
    ...
    const validateEditForm = async () => {
        ...
        if (editForm.nomor_telepon.trim() && !/^(\+62|62|0)[0-9]{9,12}$/.test(editForm.nomor_telepon)) {
        ...
        if (!idTelegramValidation.isValid) {
            errors.id_telegram = idTelegramValidation.message;
            isValid = false;
        }
    ...
    const validatePasswordForm = () => {
        ...
        // Validasi password baru menggunakan validasi yang sama dengan register
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                <Avatar className="h-20 w-20">
                                    <AvatarImage src={profile.avatar || "/avatars/default.jpg"} alt={profile.nama} />
                            ...
                            <div className="grid gap-6 sm:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div>
                                        ...
                                        >
                                            {profile.status_users === 'active' ? 'Active' : 'Inactive'}
                                        </Badge>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="font-medium text-sm">{formatDate(profile.created_at)}</p>
                                </div>

                                <div className="space-y-2">
                                    <Label className="text-muted-foreground">Terakhir Diupdate</Label>
                                    <p className="font-medium text-sm">{formatDate(profile.updated_at)}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                            ...
                            <form onSubmit={handleEditSubmit} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Username hanya boleh berisi huruf, angka, underscore, dan titik (3-20 karakter)
                                    </p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    {editErrors.nomor_telepon && (
                                        <p className="text-sm text-red-500">{editErrors.nomor_telepon}</p>
                                    )}
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    {editErrors.id_telegram && (
                                        <p className="text-sm text-red-500">{editErrors.id_telegram}</p>
                                    )}
                                    <p className="text-xs text-muted-foreground">
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Password Anda telah berhasil diubah. Untuk keamanan, Anda akan logout otomatis.
