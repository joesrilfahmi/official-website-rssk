                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            <div className="flex items-center gap-2 mb-6">
                                ...
                                <h3 className="text-xl font-bold text-mariner-500">Popular Tags</h3>
                            </div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {allTags.map((tagItem, index) => (
                                        <button
                                            ...
                                            className={`inline-flex items-center gap-1 px-3 py-2 rounded-full text-sm transition-colors ${selectedTag === tagItem.tag
                                                ? 'bg-mariner-500 text-white'
                                                : 'bg-gray-100 hover:bg-mariner-100 text-gray-700 hover:text-mariner-600'
                                                }`}
                                        >
                                            {tagItem.tag}
                                            <span className={`text-xs ${selectedTag === tagItem.tag ? 'text-white/80' : 'text-gray-500'}`}>
                                                ({tagItem.count})
                                            </span>
                                        </button>
                                    ))}
