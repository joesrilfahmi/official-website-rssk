...
const Hero: React.FC = () => {
  ...
  return (
    <div
      id="hero"
      className="min-h-screen bg-easternblue-500 relative overflow-hidden pt-32 pb-16 px-4 sm:px-6 lg:px-8"
    >
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center justify-center min-h-[calc(100vh-12rem)]">
            ...
            >
              <div className="relative w-full max-w-md">
                ...
                <div
                  className="absolute top-1/4 -right-10 w-28 h-28 bg-linear-to-br from-white/25 to-transparent rounded-full blur-2xl animate-pulse"
