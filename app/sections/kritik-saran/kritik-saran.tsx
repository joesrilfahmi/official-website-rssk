                            ...
                            {showSuccess ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-gray-600 max-w-md mx-auto">
                                        Kritik dan saran Anda telah berhasil terkirim. Kami akan menindaklanjuti masukan Anda untuk meningkatkan kualitas layanan kami.
                                    </p>
                                </div>
                            ) : (
                                <>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex items-center space-x-3 p-4 bg-blue-50 rounded-xl border-2 border-blue-100">
                                            ...
                                            />
                                            <label htmlFor="is_anonymus" className="text-gray-700 font-medium cursor-pointer">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <Select
                                                ...
                                                onChange={(value) => handleSelectChange('unit_pelayanan_id', value)}
                                                options={unitPelayananList.map(u => ({ value: u.id, label: u.title }))}
                                            ...
                                            <Select
                                                ...
                                                onChange={(value) => handleSelectChange('kategori_id', value)}
                                                options={kategoriList.map(k => ({ value: k.id, label: k.title }))}
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-2">
                                                {[1, 2, 3, 4, 5].map((star) => (
                                                    ...
                                                    >
                                                        <Star
                                                            className={`h-10 w-10 cursor-pointer transition-colors ${star <= formData.rating
