...
const KenapaMemilih: React.FC = () => {
    const mainReasons: Reason[] = [
        {
            ...
            description:
                "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed dignissim lorem quis consequat.",
    ...
    return (
        <section id="kenapa-memilih" className="bg-white py-16 px-4 sm:px-6 lg:px-8">
                                ...
                                >
                                    <div className="flex gap-3 sm:gap-4">
                                        ...
                                        <div className="flex-1 space-y-1 sm:space-y-2">
                                            <h3 className={`text-base sm:text-lg font-semibold ${reason.titleColor}`}>
                                                {reason.title}
                                            </h3>
