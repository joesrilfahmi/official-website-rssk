...
import { LucideIcon, ChevronDown, Search, X, Check, Loader2 } from 'lucide-react';
...
const Select: React.FC<SelectProps> = ({
    ...
    // Filter options
    const filteredOptions = searchable && debouncedSearch
        ? options.filter((opt) =>
    ...
    return (
        ...
        `}
            >
                ...
                <span
                    className={`block truncate pr-2 ${selectedOption ? 'text-gray-700' : 'text-gray-400'
                        }`}
                >
          ...
          `}
                ...
                >
                  ...
                  `}
                    ...
                    <div className="py-1 overflow-y-auto" style={{ maxHeight: searchable ? '256px' : '280px' }}>
